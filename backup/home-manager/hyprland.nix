...
monitor=eDP-1,1980x1080@60,auto,1
#monitor= HDMI-A-1,preferred,auto,1.6
...
general {
    ...
    # old border settings: rgba(33ccffee) rgba(00ff99ee) 45deg
...
# Screenshots
bind = ,PRINT, exec, hyprshot -m active
